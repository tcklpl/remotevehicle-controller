...
public enum PacketType {
    ...
    PACKET_SERVER_REQUESTING_IMG_CONNECTION_ATTEMPT("CFBA", PackerSender.SERVER),
    PACKET_IMG_CONNECTION_ATTEMPT("CFRA", PackerSender.CLIENT),
    PACKET_IMG_ACCEPTED_CONNECTION("CFCC", PackerSender.SERVER),
